// Generated by scripts/seed-demo.mjs. Do not edit by hand.
//
// A TypeScript module rather than a JSON import, because Node ESM requires an
// import attribute for JSON and the serverless function, the browser bundle
// and the tests all need to read the same object.
...
export const DEMO_VENUE: DemoVenue = {
